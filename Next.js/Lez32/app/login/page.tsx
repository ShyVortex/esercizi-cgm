            ...
            <div className="mt-16 mb-5 w-full max-w-md p-8 bg-gray-800/40 backdrop-blur-md rounded-2xl border border-gray-700/50 shadow-2xl transition-all duration-300">
                ...
                <Formik
                    ...
                    onSubmit={async (values, { setSubmitting }) => {
                        ...
                        try {
                            await authService.AuthLogin(values);
                            ...
                            const loggedInUser = AuthStorageService.getUser();
                            if (loggedInUser && loggedInUser.isActive === false) {
                                AuthStorageService.removeAuthData();
                                setErrorMessage("Il tuo account è inattivo. Contatta l'amministratore per abilitarlo.");
                                return;
                            }
                            ...
                            setErrorMessage(err.message || "Credenziali non valide o errore del server.");
                        } finally {
                            setSubmitting(false);
                        }
                    }}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <Field
                                        ...
                                        className={`block w-full pl-10 pr-3 py-3 bg-gray-900/60 border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-150 ${
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <Field
                                        ...
                                        disabled={isSubmitting}
                                        className={`block w-full pl-10 pr-10 py-3 bg-gray-900/60 border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-150 ${
