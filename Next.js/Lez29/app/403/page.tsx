...
export default async function ForbiddenPage(): Promise<React.ReactElement> {
    ...
    const roleName: string = roleId === "3" ? "Admin" : "Utente";
    ...
    return (
        <div className="min-h-[70vh] flex flex-col justify-center items-center text-center px-4">
            <div className="max-w-md w-full bg-gray-800/40 backdrop-blur-md rounded-2xl border border-red-500/20 shadow-2xl p-8 transition-all duration-300">
