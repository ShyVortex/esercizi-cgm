...
export class UserService {
    ...
    public getCachedFilteredUsers = (simulate: boolean, request: GetFPUsersRequest) => {
        return unstable_cache(
            async () => {
                return await userService.getFilteredPaginatedUsers(simulate, request);
            },
    ...
    public getCachedUserDetail = (userId: string, simulate: boolean = false) => {
        return unstable_cache(
            async () => {
                return await userService.getUser(userId, simulate);
            },
            ['user-detail', userId],
            {
