...
function controllaCampi(tipoCliente: string): boolean {
    ...
    const nome: string = campoNome.value;
    const cognome: string | undefined = tipoCliente === 'persona' ? campoCognome.value : undefined;
    const formaSocietaria: string | undefined = tipoCliente === 'azienda' ? campoFormaSocietaria.value : undefined;
